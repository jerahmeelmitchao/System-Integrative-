            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        <div class="header-text mb-4 d-flex justify-content-between align-items-center">
                            <h2>Register as Admin</h2>
                            <!-- Close Button -->
                            <button type="button" class="btn btn-close" onclick="goBack()" aria-label="Close"></button>
                        </div>
                        ...
                        <form method="POST" action="{{ route('auth.adminregister.submit') }}">
                            @csrf
